    <nav class="sidebar sidebar-offcanvas" id="sidebar">
        <ul class="nav">
            ...
            if (in_array('13', \Session::get('menuList'))) { ?>
                <li class="nav-item">
            ...
            <?php if (in_array('15', \Session::get('menuList')) || in_array('16', \Session::get('menuList'))) { ?>
                <li class="nav-item">
                    <a class="nav-link" data-bs-toggle="collapse" href="#component" aria-expanded="false"
                        ...
                        <ul class="nav flex-column sub-menu">
                            <?php if (in_array('18', \Session::get('menuList'))) { ?>
                                <li class="nav-item">
                                    ...
                                    if (in_array('19', \Session::get('menuList'))) { ?>
                                <li class="nav-item">
                        ...
                        <ul class="nav flex-column sub-menu">
                            <?php if (in_array('21', \Session::get('menuList'))) { ?>
                                <li class="nav-item">
                                    ...
                                    if (in_array('22', \Session::get('menuList'))) { ?>
                                <li class="nav-item">
            ...
            <?php if (in_array('25', \Session::get('menuList')) || in_array('26', \Session::get('menuList'))) { ?>
                <li class="nav-item">
                    <a class="nav-link" data-bs-toggle="collapse" href="#distributor" aria-expanded="false"
                        aria-controls="distributor">
                        ...
                        <ul class="nav flex-column sub-menu">
                            <?php if (in_array('25', \Session::get('menuList'))) { ?>
                                <li class="nav-item">
                                    ...
                                    if (in_array('26', \Session::get('menuList'))) { ?>
                                <li class="nav-item">
                    ...
                    <div class="collapse" id="company">
                        <ul class="nav flex-column sub-menu">
                            <?php if (in_array('28', \Session::get('menuList'))) { ?>
                                <li class="nav-item">
                                    <a class="nav-link" href="{{ route('companyclient.basicinfocreate', 0) }}">Add New
                                        Company</a>
                                </li> <?php }
                                    if (in_array('29', \Session::get('menuList'))) { ?>
                                <li class="nav-item">
            ...
            <?php if (in_array('47', \Session::get('menuList')) || in_array('48', \Session::get('menuList'))) { ?>
                <li class="nav-item">
                    <a class="nav-link" data-bs-toggle="collapse" href="#Projects" aria-expanded="false"
                        aria-controls="Projects">
                        <i class="mas-project menu-icon"></i>
                    ...
                    <div class="collapse" id="Projects">
                        <ul class="nav flex-column sub-menu">
                            <?php if (in_array('48', \Session::get('menuList'))) { ?>
                                <li class="nav-item">
                                    <a class="nav-link" href="{{ route('projects.index') }}">List of
                                        Projects</a>
                                </li> <?php } ?>
                            <?php if (in_array('53', \Session::get('menuList'))) { ?>
                                <li class="nav-item">
                                    <a class="nav-link" href="{{ route('projects.projectsSummayReports') }}">Project Summary</a>
                                </li> <?php } ?>
                        </ul>
                    </div>
            ...
            {{-- Rma new add code start --}}
            <?php

            if (in_array('50', \Session::get('menuList')) || in_array('51', \Session::get('menuList')) || in_array('52', \Session::get('menuList'))) { ?>
                <li class="nav-item">
                    <a class="nav-link" data-bs-toggle="collapse" href="#Rma" aria-expanded="false"
                        aria-controls="Rma">
                        <i class="mas-return-box menu-icon"></i>
                        <span class="menu-title">RMA</span>
                        <i class="menu-arrow"></i>
                    </a>
                    <div class="collapse" id="Rma">
                        <ul class="nav flex-column sub-menu">
                            <?php if (in_array('51', \Session::get('menuList'))) { ?>
                                <li class="nav-item">
                                    <a class="nav-link" href="{{ route('Wl_RMA.index') }}">RMA Summary</a>
                                </li>
                            <?php } ?>
                            <?php if (in_array('52', \Session::get('menuList'))) { ?>
                                <li class="nav-item">
                                    <a class="nav-link" href="{{ route('Wl_RMA.rma_month_summary') }}">RMA Monthly
                                        Summary</a>
                                </li>
                            <?php } ?>
                        </ul>
            ...
            {{-- rma new add end code --}}


            <?php if (in_array('31', \Session::get('menuList')) || in_array('32', \Session::get('menuList'))) { ?>
                <li class="nav-item">
                    <a class="nav-link" data-bs-toggle="collapse" href="#faq" aria-expanded="false"
                        aria-controls="faq">
                        ...
                        <ul class="nav flex-column sub-menu">
                            <?php if (in_array('31', \Session::get('menuList'))) { ?>
                                <li class="nav-item">
                                    ...
                                    if (in_array('32', \Session::get('menuList'))) { ?>
                                <li class="nav-item">
            ...
            <?php if (in_array('34', \Session::get('menuList')) || in_array('35', \Session::get('menuList'))) { ?>
                <li class="nav-item">
                    <a class="nav-link" data-bs-toggle="collapse" href="#ref" aria-expanded="false"
                        aria-controls="ref">
                        ...
                        <ul class="nav flex-column sub-menu">
                            <?php if (in_array('34', \Session::get('menuList'))) { ?>
                                <li class="nav-item">
                                    ...
                                    if (in_array('35', \Session::get('menuList'))) { ?>
                                <li class="nav-item">
                        ...
                        <ul class="nav flex-column sub-menu">
                            <?php if (in_array('37', \Session::get('menuList'))) { ?>
                                ...
                                <?php if (in_array('46', \Session::get('menuList'))) { ?>
                                    <li class="nav-item">
                                        <a class="nav-link" href="{{ route('downloadCall.index') }}">Download Reports</a>
                                    </li>
                            <?php } 
                            //if (in_array('54', \Session::get('menuList'))) { ?>
                              <!--      <li class="nav-item">
                                        <a class="nav-link" href="{{ route('rmaDownloadReport.index') }}">Download RMA Report</a>
                                    </li>-->
                            <?php // } 
                            } ?>
                            <?php if (in_array('49', \Session::get('menuList'))) { ?>
                                <li class="nav-item">
                                    <a class="nav-link" href="{{ route('distributorsummary.index') }}">Distributor
                                        Summary</a>
                                </li>
                            <?php }
                            ?>
