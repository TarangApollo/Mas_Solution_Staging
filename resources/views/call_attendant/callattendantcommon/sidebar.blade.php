<nav class="bottom-navbar">
    <div class="container">
        ...
        if (is_array($menuList) && (in_array('50', \Session::get('menuList')) || in_array('51', \Session::get('menuList'))   || in_array('52', \Session::get('menuList')))) { ?>
            <li class="nav-item">
                <a class="nav-link" href="{{ route('rma.index') }}">
                    <i class="mas-add-complaints menu-icon"></i>
                    <span class="menu-title">
                        RMA 
                    </span>
            ...
            <li class="nav-item">
                <a class="nav-link" href="{{ route('rma.list') }}">
