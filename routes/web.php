...
use App\Http\Controllers\RmaDownloadReportController;
/*
|--------------------------------------------------------------------------
| Web Routes
|--------------------------------------------------------------------------
...
Route::prefix('profile')->name('profile.')->middleware('auth', 'ipcheck')->group(function () {
    ...
    Route::post('/getAnalyticsLineChart', [HomeController::class, 'getAnalyticsLineChart'])->name('getAnalyticsLineChart');
     Route::post('/get_rmaPiaChart', [HomeController::class, 'get_rma_PiaChart'])->name('get_rmaPiaChart');
    Route::post('/get_rmaLineChart', [HomeController::class, 'get_rmaLineChart'])->name('get_rmaLineChart');
});

Route::name('User.')->middleware('auth', 'ipcheck')->group(function () {
    Route::any('/select/switch-user', [HomeController::class, 'selectswitchuser'])->name('selectswitchuser');
    Route::any('/switch-user', [HomeController::class, 'switchuser'])->name('switch');
    Route::any('/wladmin/Wladmin-Dashboard', [HomeController::class, 'switchusersubmit'])->name('switchsubmit');
    Route::any('/switch-WLUser/{company?}/{user?}', [HomeController::class, 'switchWLuser'])->name('switchWL');
    Route::any('/wladmin/Wladmin/Dashboard', [HomeController::class, 'switchWLsubmit'])->name('switchWLsubmit');
});
...
Route::prefix('company')->name('company.')->middleware('auth', 'ipcheck')->group(function () {
    ...
    Route::get('/{id?}/allow-moduleCreate', [CompanyMasterController::class, 'allowmodulecreate'])->name('allow-module');
    Route::post('/allow-module/store/', [CompanyMasterController::class, 'allowmodulestore'])->name('allowmodulestore');
    ...
    Route::post('/companymigration', [CompanyMasterController::class, 'migration'])->name('migration');
});
...
Route::prefix('call_attendant')->name('call_attendant.')->middleware('auth', 'ipcheck')->group(function () {
    ...
    Route::get('/mapping/company/role', [CallAttendantController::class, 'mappingcompanyrole'])->name('mappingcompanyrole');
...
Route::prefix('projects')->name('projects.')->middleware('auth', 'ipcheck')->group(function () {
    ...
    Route::delete('/deletedoc/{id?}', [ProjectsController::class, 'deletedoc'])->name('deletedoc');
    Route::any('/adddoc', [ProjectsController::class, 'AddDocument'])->name('AddDocument');

    Route::post('/projects/reorder/column', [ProjectsController::class, 'reorder_column'])->name('reorder_column');
    
    Route::any('/projects-summay-reports', [ProjectsController::class, 'projectsSummayReports'])->name('projectsSummayReports');
    Route::get('/projects/summay-reports/Summay-Info/{id?}', [ProjectsController::class, 'projectsSummayReportsInfoview'])->name('projectsSummayReportsInfoview');
    Route::get('/projects/summay/reports/info/{id?}', [ProjectsController::class, 'projectsSummayReportsInfo'])->name('projectsSummayReportsInfo');
});
...
Route::prefix('callList')->name('callList.')->middleware('auth', 'ipcheck')->group(function () {
    ...
    Route::post('/reorder/column', [CallListController::class, 'reorder_column'])->name('reorder_column');
});
...
Route::prefix('my-tickets')->name('my-tickets.')->middleware('auth', 'ipcheck')->group(function () {
    ...
    Route::get('/update_aws_called_identifier', [MyTicketController::class, 'updateAwsCalledIdentifier'])->name('updateAwsCalledIdentifier');
    ...
    Route::post('/reorder/column', [MyTicketController::class, 'reorder_column'])->name('reorder_column');
});
...
Route::prefix('complaint')->name('complaint.')->middleware('auth', 'ipcheck')->group(function () {
    ...
    Route::post('/reorder/column', [ComplaintsController::class, 'reorder_column'])->name('reorder_column');

    Route::get('/get/ticket/detail/data/{id?}', [ComplaintsController::class, 'get_ticket_detail_data'])->name('get_ticket_detail_data');

    Route::post('/ticket/detail/data/update/{id?}', [ComplaintsController::class, 'ticket_detail_data_update'])->name('ticket_detail_data_update');
});
...
Route::any('/checkbox', [HeaderController::class, 'checkbox'])->name('checkbox');
Route::any('/getStoredData', [HeaderController::class, 'getStoredData'])->name('getStoredData');
...
Route::prefix('call_report')->name('call_report.')->middleware('auth', 'ipcheck')->group(function () {
    ...
    Route::post('/reorder/column', [CallReportController::class, 'reorder_column'])->name('reorder_column');
});
...
//RMA
Route::prefix('rma')->name('rma.')->middleware('auth', 'ipcheck')->group(function () {
    Route::get('/add', [RMAController::class, 'index'])->name('index');
    Route::any('/list', [RMAController::class, 'rmalist'])->name('list');
    Route::post('/store', [RMAController::class, 'store'])->name('store');
    Route::post('/get/details', [RMAController::class, 'get_details'])->name('get_details');
    Route::get('/additional/{id?}', [RMAController::class, 'additional_rma'])->name('additional_rma');
    Route::post('/additional/store', [RMAController::class, 'additional_rma_store'])->name('additional_rma_store');
    Route::get('/info/{id?}', [RMAController::class, 'rma_info'])->name('rma_info');
    Route::get('/edit/{id?}', [RMAController::class, 'rma_edit'])->name('rma_edit');
    Route::post('/update', [RMAController::class, 'rma_update'])->name('rma_update');
    Route::post('/rma_detail_update/{id?}', [RMAController::class, 'rma_detail_update'])->name('rma_detail_update');
    Route::delete('/rma_delete/{id?}', [RMAController::class, 'rma_image_delete'])->name('rma_delete');
    Route::delete('/rma_detail_delete/{id?}', [RMAController::class, 'rma_detail_delete'])->name('rma_detail_delete');
    Route::get('/{Id?}/openDocument', [RMAController::class, 'openDocument'])->name('openDocument');
    Route::get('/rmadetailedit/{id?}', [RMAController::class, 'rmadetail_edit'])->name('rmadetail_edit');
    Route::any('/get_Complaint_id/{id?}', [RMAController::class, 'get_Complaint_id'])->name('get_Complaint_id');
    Route::post('/reorder/column', [RMAController::class, 'reorder_column'])->name('reorder_column');
});

Route::prefix('Wl_RMA')->name('Wl_RMA.')->middleware('auth', 'ipcheck')->group(function () {
    Route::any('/wl_index', [RMAController::class, 'wl_index'])->name('index');
    Route::get('/rma-summary-info/{id?}', [RMAController::class, 'rma_summary_info'])->name('rma_summary_info');
    Route::any('/rma-month-summary', [RMAController::class, 'rma_month_summary_index'])->name('rma_month_summary');
    Route::get('/rma_month_summary_info/{id?}', [RMAController::class, 'rma_month_summary_info'])->name('Rma_Summary_Info_Detail');
    Route::get('/rma_month_call_info/{id?}', [RMAController::class, 'rma_month_call_info'])->name('rma_month_call_info');
    Route::post('/reorder/column', [RMAController::class, 'reorder_column_rma_detail'])->name('rma_detail_reorder_column');
});

//02-06-2025
//Rma Download Report
Route::prefix('rmaDownloadReport')->name('rmaDownloadReport.')->middleware('auth', 'ipcheck')->group(function () {
    Route::any('/rma/download/report/index', [RmaDownloadReportController::class, 'index'])->name('index');
    Route::any('/rma/download/report/download', [RmaDownloadReportController::class, 'download'])->name('download');
});
